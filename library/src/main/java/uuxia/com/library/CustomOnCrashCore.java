...
public final class CustomOnCrashCore {
    ...
    //General constants
    private final static String TAG = "CustomOnCrashCore";
        ...
        try {
            if (context == null) {
                ...
                if (oldHandler != null && oldHandler.getClass().getName().startsWith(CAOC_HANDLER_PACKAGE_NAME)) {
                    Log.e(TAG, "You have already installed CustomOnCrashCore, doing nothing!");
                } else {
                    if (oldHandler != null && !oldHandler.getClass().getName().startsWith(DEFAULT_HANDLER_PACKAGE_NAME)) {
                        Log.e(TAG, "IMPORTANT WARNING! You already have an UncaughtExceptionHandler, are you sure this is correct? If you use ACRA, Crashlytics or similar libraries, you must initialize them AFTER CustomOnCrashCore! Installing anyway, but your original handler will not be called.");
                    }
                    ...
                    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            Log.e(TAG, "App has crashed, executing CustomOnCrashCore's UncaughtExceptionHandler", throwable);
                    ...
                    Log.i(TAG, "CustomOnCrashCore has been installed.");
                }
            }
        } catch (Throwable t) {
    ...
    public static Class<? extends Activity> getRestartActivityClassFromIntent(Intent intent) {
        Serializable serializedClass = intent.getSerializableExtra(CustomOnCrashCore.EXTRA_RESTART_ACTIVITY_CLASS);
    ...
    private static Class<? extends Activity> guessRestartActivityClass(Context context) {
        ...
        resolvedActivityClass = CustomOnCrashCore.getRestartActivityClassWithIntentFilter(context);
    ...
    private static Class<? extends Activity> guessErrorActivityClass(Context context) {
        ...
        //If action is defined, use that
        resolvedActivityClass = CustomOnCrashCore.getErrorActivityClassWithIntentFilter(context);
